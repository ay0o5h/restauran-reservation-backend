    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, Admin_1.Admin.findOne(payload.id)];
            case 2:
                admin = _a.sent();
                // check user isVerified
                if (admin.isVerified)
                    return [2 /*return*/, (0, util_service_1.errRes)(res, "alreadyVerified", 400, lang)];
                req.admin = admin;
                // next
                return [2 /*return*/, next()];
            case 3:
                error_1 = _a.sent();
                return [2 /*return*/, (0, util_service_1.errRes)(res, error_1)];
