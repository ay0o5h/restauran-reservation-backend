...
exports.default = (function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var lang, token, payload, admin, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, Admin_1.Admin.findOne({ where: { id: payload.id, isActive: true } })];
            case 2:
                admin = _a.sent();
                console.log({ admin: admin, payload: payload });
                if (!admin.isActive)
                    return [2 /*return*/, (0, util_service_1.errRes)(res, "notActive", 400, lang)];
                if (!admin.isVerified)
                    return [2 /*return*/, (0, util_service_1.errRes)(res, "verifyAccount", 400, lang)];
                req.admin = admin;
                // next
